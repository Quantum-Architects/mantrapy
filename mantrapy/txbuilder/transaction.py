...
def create_sig_doc(body: TxBody, auth_info: AuthInfo, chain_id:str, account_number:int):
    doc = SignDoc()
...
def create_tx_template( msg: Message,
                       memo: str,
                       fee_amount: str,
                       fee_denom: str,
                       gas_limit: str,
    ...
    return create_body_bytes(msg, memo), create_auth_info_bytes(create_signer_info(pubkey, sequence),create_fee(fee_amount, fee_denom, gas_limit))
#
